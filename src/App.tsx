...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <header className="app-header"><a className="brand" href="/" aria-label="Vault Watch home"><span className="brand-mark"><Icon name="explore" /></span><span>Vault Watch</span></a><div className="header-actions"><button className="text-button" onClick={() => setModal("help")}>Help</button><button className="button" onClick={() => setModal("tools")}><Icon name="settings" />Settings</button></div></header>
