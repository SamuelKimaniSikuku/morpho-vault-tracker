    ...
    <main id="dashboard">
      ...
      {view === "watchlist" && <section className="vault-workspace" aria-label="Your vaults">
        ...
        {vaultCount > 0 ? <>
          ...
          <p className="table-note">Liquidity is the amount the source reports as available to withdraw. — means not reported.<span className="liquidity-history-note">Charts show readings collected on this device while this page is open, up to 24 hours.</span></p>
