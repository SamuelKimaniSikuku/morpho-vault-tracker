...
export function BeginnerGuide() {
  return <div className="beginner-guide">
    <p>VaultWatch helps you follow earning rates offered by crypto platforms. Adding a market saves it to your watchlist. It does not invest or move any money.</p>
    <ol className="getting-started"><li><strong>Find a market.</strong> Search for a name or a coin you already use, or upload a screenshot.</li><li><strong>Add it to your watchlist.</strong> You can follow several markets without connecting a wallet.</li><li><strong>Check back here.</strong> See the latest rate and whether an update is missing. Select a market name for more details.</li></ol>
    <dl className="plain-glossary">
      <div><dt>Vault or market</dt><dd>A place on a crypto platform that offers a way to earn a return. The rules and risks differ between markets.</dd></div>
      <div><dt>Platform</dt><dd>The crypto service behind a market, such as Morpho or Pendle.</dd></div>
      <div><dt>Network</dt><dd>The blockchain it runs on, such as Ethereum or Base. Similar names on different networks can refer to different markets.</dd></div>
