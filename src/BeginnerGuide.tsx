...
export function BeginnerGuide() {
  return <div className="beginner-guide">
    ...
    <ol className="getting-started"><li><strong>Add a vault.</strong> Use Add vault or Upload screenshot at the top of Your vaults.</li><li><strong>Add it to your watchlist.</strong> You can follow several vaults without connecting a wallet.</li><li><strong>Check back here.</strong> See the yearly rate, total deposits and available liquidity. Select a vault name for more details.</li></ol>
    <dl className="plain-glossary">
      ...
      <div><dt>Liquidity</dt><dd>The amount the source reports as available to withdraw. It can be lower than total deposits. A dash means the source does not report it.</dd></div>
      ...
      <div><dt>Loans</dt><dd>Fixed-term lending and borrowing markets. Switch between Borrow to see yearly costs and Lend to see yearly returns.</dd></div>
      <div><dt>Fixed-term yield</dt><dd>Markets with an end date. The “Fixed asset” tag describes the type of rate, not a guarantee that the coin's price stays the same.</dd></div>
    </dl>
    <RateGuide />
